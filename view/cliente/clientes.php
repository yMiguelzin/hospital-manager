...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title text-center">Cadastro de Consultas</h6>
                    <form name="form_cliente">
    <div class="form-group">
        <div class="input-field">
            <label for="cli_nome">Nome</label>
            <input type="text" required="" class="form-control" id="cli_nome" name="cli_nome">
        </div>
        <br>
    </div>
    <div class="form-group">
        <div class="input-field">
            ...
            <input type="text" required="" class="form-control" id="cli_email" name="cli_email">
        </div>
        <br>
    </div>
    <div class="form-group">
        <div class="input-field">
            ...
            <input type="number" required="" class="form-control" id="cli_telefone" name="cli_telefone">
        </div>
        <br>
    </div>
    <div class="form-group">
        <div class="input-field">
            ...
            <input type="text" required="" class="form-control" id="cli_endereco" name="cli_endereco">
        </div>
        <br>
    </div>
    <div class="form-group">
        <div class="input-field">
            ...
            <input type="date" class="form-control" id="cli_nascimento" name="cli_nascimento">
        </div>
        <br>
    </div>
    <div class="form-group">
